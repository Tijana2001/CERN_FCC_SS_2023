...
namespace FCCAnalyses {
  ...
  */
    ...
    int get_n(ROOT::VecOps::RVec<fastjet::PseudoJet>& in);

     /// return reconstructed particles
    ROOT::VecOps::RVec<fastjet::PseudoJet> get(ROOT::VecOps::RVec<int> index, ROOT::VecOps::RVec<fastjet::PseudoJet>& in);
