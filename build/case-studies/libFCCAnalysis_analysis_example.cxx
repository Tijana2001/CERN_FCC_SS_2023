...
#include "/afs/cern.ch/user/t/tcvijeti/tt/FCCAnalyses/case-studies/analysis_example/include/DummyAnalysis.h"
#include "/afs/cern.ch/user/t/tcvijeti/tt/FCCAnalyses/case-studies/analysis_example/src/classes.h"
...
namespace ROOT {
   ...
   {
      return GenerateInitInstanceLocal((::analysis_example::dictionary*)nullptr);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::analysis_example::dictionary*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *analysis_examplecLcLdictionary_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::analysis_example::dictionary*)nullptr)->GetClass();
...
namespace ROOT {
   ...
   static void delete_analysis_examplecLcLdictionary(void *p) {
      delete ((::analysis_example::dictionary*)p);
   }
   static void deleteArray_analysis_examplecLcLdictionary(void *p) {
      delete [] ((::analysis_example::dictionary*)p);
   }
...
"/afs/cern.ch/user/t/tcvijeti/tt/FCCAnalyses/case-studies",
"/cvmfs/sw.hsf.org/spackages7/root/6.26.10/x86_64-centos7-gcc11.2.0-opt/i4xdf/include/root",
"/afs/cern.ch/user/t/tcvijeti/tt/FCCAnalyses/build/case-studies/",
nullptr
    };
